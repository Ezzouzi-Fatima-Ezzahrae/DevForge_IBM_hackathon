...
def get_impact_summary(project_id: str) -> str:
    ...
    lines = [
        ...
        "─" * 46,
        f"  ⏱  Total tracked time : {total_time:.1f}s",
        f"     • Planning         : {s['planning_time_seconds']:.1f}s",
        f"     • Implementation   : {s['implementation_time_seconds']:.1f}s",
        f"     • Testing          : {s['testing_time_seconds']:.1f}s",
        f"     • Debugging        : {s['debugging_time_seconds']:.1f}s",
